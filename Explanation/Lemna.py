        ...
        for k in range(K):
            ...
            if len(labels_of_k) > 0:
                if linreg_type == 'fused_lasso':
                    ...
                    reg = linear_model.Lasso(alpha=alpha_S, fit_intercept=True, precompute=True, copy_X=True, max_iter=3000, tol=1e-4, warm_start=False, positive=False, random_state=None, selection="cyclic")
